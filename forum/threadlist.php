...
<body>
    ...
    <?php
        ...
        if($method=='POST'){
           ...
           if($showAlert){
               ...
               <strong>Success!</strong> You thread has been added! Please wait for community respond. 
    ...
    <div class="container my-4">
        <div class="jumbotron">
            ...
            <a class="btn btn-success btn-lg" href="#" role="button"><b>Posted by:<i>Ankit</i></b></a>
        </div>
    </div>
    <?php 
...
echo '<div class="container">
    ...
    //   echo "You are not logged in.";
         echo ' <div class="container">
         <h1 class="py-2"> Start a Discussion</h1>
                <p class="lead">You are not logged in. Please login to be able to stast a Discussion </p>
            </div>';
  }
    ?>
    ...
    <div class="container mb-5" id="ques">
        ...
        echo    '<div class="media  my-3">
                        <img src="img/userdefault.jpg" width="55px" class="mr-3" alt="...">
    ...
    <!-- <div class="media  my-3">
            <img src="img/userdefault.jpg" width="55px" class="mr-3" alt="...">
            <div class="media-body">
                <h5 class="mt-0">unable to pyaudio erro in windows</h5>
