...
<body>
    ...
    <?php
        ...
        if($method=='POST'){
           ...
           $comment = str_replace(">","&gt;",$comment);
           $sno = $_POST['sno'];
           $sql = "INSERT INTO `comments` (`comment_content`,
            `thread_id`, `comment_by`, `comment_time`)
...
echo '<div class="container">
        ...
        //   echo "You are not logged in.";
             ...
             <h1 class="py-2">Post Comment</h1>
                    <p class="lead">You are not logged in. Please login to be able to stast a Post comments. </p>
                </div>';
      }
?>
